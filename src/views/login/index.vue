    ...
    <div class="login-weaper">
      ...
      <div class="login-right">
        <div class="login-main">
          <h4 class="login-title">中联惠捷决策引擎系统</h4>
              ...
              <!--<div class="el-row" span="24">-->
                ...
                <!--<div class="el-col el-col-8">-->
                  <!--<div class="login-code">-->
                    <!--<span class="login-code-img" @click="onLoginCodeClick">{{loginCode}}</span>-->
                  <!--</div>-->
                <!--</div>-->
              <!--</div>-->
            <!--</el-form-item>-->
            <el-form-item style="margin: 40px 0px 0">
              <el-button type="primary" class="login-submit" @click="submitForm('ruleForm')" :loading="submit.loading">登录</el-button>
            </el-form-item>
          </el-form>
...
export default {
  ...
  data() {
    ...
    const validateUserName = (rule, value, callback) => {
      ...
      // else if (value !== "zlhjadmin" && value !== "test") {
  ...
  methods: {
      // 登录按钮点击
      submitForm(formName) {
          let encryptPsw = binl2b64(this.ruleForm.password);
